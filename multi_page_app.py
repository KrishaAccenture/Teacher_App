...
Complete Understanding of UK National Curriculum: thoroughly analyze the UK National Curriculum document "The national curriculum in England - Framework document" to fully grasp the educational structure and requirements of the UK. This understanding should be reflected in the content's alignment with the curriculum's objectives and standards.
...
def show_history_entry_details(index):
    ...
    st.write(f"Subject: {entry['user_input']}")
...
def main():
    ...
    with st.sidebar:
        st.header("History")
        for index, _ in enumerate(st.session_state.history):
